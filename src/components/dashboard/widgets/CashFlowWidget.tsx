...
const CashFlowWidget = ({ onRemove, isEditMode, data, country }: CashFlowWidgetProps) => {
  return (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              ...
              <Tooltip
                ...
                formatter={(value: number) => [formatCurrency(value, country), "Cash Flow"]}
              />
              <Area type="monotone" dataKey="cashFlow" stroke="#06b6d4" fill="rgba(6, 182, 212, 0.3)" strokeWidth={2} />
            </AreaChart>
          </ResponsiveContainer>
        )}
      </CardContent>
