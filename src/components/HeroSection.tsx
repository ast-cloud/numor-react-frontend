...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-24 lg:pt-16 overflow-hidden">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-4 sm:px-12 md:px-16 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Subheadline */}
            <p
              className="text-base sm:text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0 mb-6 pb-3 animate-slide-up delay-100"
            ...
            {/* Trust badges */}
            <div
              className="mt-6 pt-3 border-t border-border/30 animate-slide-up delay-300"
              style={{ opacity: 0, animationFillMode: "forwards" }}
            >
