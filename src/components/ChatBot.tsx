      ...
      {isOpen && (
        <>
          ...
          <div 
            ...
            aria-hidden="true"
          />
          <div className="fixed bottom-6 right-6 z-50 w-[340px] h-[480px] bg-card rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-border/50 origin-bottom-right animate-[bounce-in_0.25s_ease-out]">
          {/* Header */}
